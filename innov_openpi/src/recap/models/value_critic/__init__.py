"""ValueCriticModel factory for ReCap.

Migrated from rlinf/models/embodiment/value_model/__init__.py.
"""
...
def get_model(cfg: dict[str, Any] | Any, torch_dtype=None) -> ValueCriticModel:
    """Build a ValueCriticModel.

    Args:
        cfg: Config dict or object with attribute access. Expected keys:
    ...
    # Support both dict and object-with-attribute-access (e.g. Hydra DictConfig)
    ...
    critic_kwargs = {
        "critic_expert_variant": _get("critic_expert_variant", "gemma_100m"),
        "num_bins": _get("num_bins", 201),
        "v_min": _get("v_min", -1.0),
        "v_max": _get("v_max", 0.0),
        "value_dropout": _get("value_dropout", 0.0),
    }
    ...
    model_path = _get("model_path", None)
