...
Use :class:`openpi_value.training.config.LeRobotDataConfig` to create a data config
...
from openpi_value.shared.image_tools import parse_image
...
class LeRobotInputs(transforms.DataTransformFn):
    ...
    # The action dimension of the model. Used to pad the state to the action dim.
    action_dim: int
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # State: expected flat array, padded to action_dim
